...
For information on setting up a local development environment that spans multiple repositories, refer to the [Architecture](./00-architecture) page for data flow understanding and individual repository documentation for specific setup instructions.
