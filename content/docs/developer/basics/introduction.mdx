...
- [Create a Template](/docs/developer/templates) - Build project scaffolds
- [Create a Processor](/docs/developer/processors) - Build file transformers
- [Create a Resolver](/docs/developer/resolvers) - Build conflict resolvers
- [Create a Plugin](/docs/developer/plugins) - Build post-processors
