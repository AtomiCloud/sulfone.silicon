...
- [Plugins vs Processors](/docs/developer/plugins/explanation/plugins-vs-processors) - Comparison
- [What Are Plugins](/docs/developer/plugins/explanation/what-are-plugins) - Plugin concepts
