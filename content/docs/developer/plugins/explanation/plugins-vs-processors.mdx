...
- [Processor Documentation](/docs/developer/processors) - Full processor reference
- [Execution Order](/docs/developer/plugins/explanation/execution-order) - Detailed pipeline sequence
