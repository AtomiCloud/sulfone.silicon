...
- Dockerfile includes `LABEL cyanprint.dev=true` (see [Plugin Dockerfile](/docs/developer/plugins/reference/dockerfile))
...
<Callout type="info">
For details on registering your plugin with the CyanPrint registry, refer to the [Plugin Registry](/docs/developer/plugins/reference/registry) documentation.
</Callout>
