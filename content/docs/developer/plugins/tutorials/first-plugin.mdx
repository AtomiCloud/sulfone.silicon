...
Create a `test.cyan.yaml` with input fixtures and expected snapshots. See [Automated Testing](/docs/developer/plugins/how-to/automated-testing) for the full guide.
...
<Cards>
  ...
  <Card href="/docs/developer/plugins/how-to/automated-testing" title="Automated Testing">
    Snapshot-based testing for plugins
  </Card>
</Cards>
