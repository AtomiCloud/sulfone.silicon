...
- [Run Shell Commands](/docs/developer/plugins/how-to/run-commands) - Command execution patterns
- [Modify Generated Files](/docs/developer/plugins/how-to/modify-files) - Edit files in the directory
- [Plugin Input/Output](/docs/developer/plugins/reference/sdk/input-output) - Full API reference
