...
- Dockerfile includes `LABEL cyanprint.dev=true` (see [Dockerfile Reference](/docs/developer/processors/reference/dockerfile))
...
<Tabs groupId="registry" items={['Docker Hub', 'GHCR', 'Private Registry']} persist>
...
return {
  processors: [{
    name: 'username/my-processor:1.0.0',  // !callout[/1.0.0/] Pin to specific Docker tag
...
<Callout type="info">
For details on registering your processor with the CyanPrint registry, refer to the [Zinc Registry API](/docs/contributor/repositories/zinc) documentation. Use the `POST /api/v1/processor/push/{username}` endpoint to register your processor.
</Callout>
...
- [First Processor Tutorial](/docs/developer/processors/tutorials/first-processor) - Create your first processor
- [Project Structure](/docs/developer/processors/reference/project-structure) - Processor file layout
- [Dockerfile Reference](/docs/developer/processors/reference/dockerfile) - Dockerfile best practices
