...
Create a `test.cyan.yaml` with multi-origin input fixtures and expected snapshots. See [Automated Testing](/docs/developer/resolvers/how-to/automated-testing) for the full guide.
...
<Cards>
  ...
  <Card href="/docs/developer/resolvers/how-to/automated-testing" title="Automated Testing">
    Snapshot-based testing for resolvers
  </Card>
</Cards>
