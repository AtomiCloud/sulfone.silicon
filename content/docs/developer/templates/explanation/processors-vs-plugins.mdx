...
See [Processor Development](/docs/developer/processors) for details.
...
See [Plugin Development](/docs/developer/plugins) for details.
...
- [Processor Development](/docs/developer/processors) - Creating custom processors
- [Plugin Development](/docs/developer/plugins) - Creating custom plugins
- [Use Custom Processor](/docs/developer/templates/how-to/use-custom-processor) - How-to guide
