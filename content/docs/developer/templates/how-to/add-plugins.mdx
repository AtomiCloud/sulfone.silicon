...
<Callout type="info">
See [Plugin Development](/docs/developer/plugins) for creating custom plugins.
</Callout>

## Related

- [Plugin Development](/docs/developer/plugins) - Create custom plugins
- [Processors vs Plugins](/docs/developer/templates/explanation/processors-vs-plugins) - When to use each
- [Full Example](/docs/developer/templates/tutorials/full-example) - Complete template with plugins
