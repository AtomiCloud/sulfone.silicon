...
Clean syntax for conditional additions:
...
- [Changing Glob Patterns](/developer/templates/tutorials/03-changing-glob) - Tutorial on glob patterns
- [Full Example](/developer/templates/tutorials/full-example) - Complete template with conditionals
- [Globbing Reference](/developer/templates/reference/sdk/globbing) - Glob syntax
