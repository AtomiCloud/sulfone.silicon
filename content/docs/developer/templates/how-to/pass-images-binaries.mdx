...
- [Globbing Reference](/developer/templates/reference/sdk/globbing) - Glob syntax reference
- [Conditional Files](/developer/templates/how-to/conditional-files) - Include files conditionally
