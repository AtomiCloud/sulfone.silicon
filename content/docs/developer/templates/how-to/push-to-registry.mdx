...
<Callout type="info">
See [Docker vs Cyan Registry](/docs/developer/templates/explanation/docker-vs-cyan-registry) for the differences between Docker registries and CyanPrint's internal registry.
</Callout>

## Related

- [Docker vs Cyan Registry](/docs/developer/templates/explanation/docker-vs-cyan-registry) - Registry comparison
- [Project Structure](/docs/developer/templates/reference/project-structure) - Template project structure
- [Dockerfiles Reference](/docs/developer/templates/reference/dockerfiles) - Dockerfile configuration
