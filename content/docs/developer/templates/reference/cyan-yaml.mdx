...
<Cards>
  ...
  <Card title="Build Configuration" href="/docs/developer/templates/reference/build-config">
    Docker buildx setup
  </Card>
  <Card title="Dev Configuration" href="/docs/developer/templates/reference/dev-config">
    Dev mode setup
  </Card>
