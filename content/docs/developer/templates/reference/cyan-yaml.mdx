...
- Version is optional: `myorg/processor` (latest) or `myorg/processor:3` (specific version)
- Versions are auto-incrementing integers managed by the registry (not semantic versions)
...
- Version is optional: `cyan/init-git` (latest) or `cyan/init-git:1` (specific version)
- Versions are auto-incrementing integers managed by the registry (not semantic versions)
...
- Version is optional: `myorg/base-node` (latest) or `myorg/base-node:3` (specific version)
- Versions are auto-incrementing integers managed by the registry (not semantic versions)
...
- [Project Structure](/docs/developer/templates/reference/project-structure) - Template files organization
- [Dockerfiles Reference](/docs/developer/templates/reference/dockerfiles) - Docker configuration
- [Compose Templates](/docs/developer/templates/how-to/compose-templates) - Composition how-to
