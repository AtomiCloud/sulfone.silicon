...
- [Tutorial: Changing Glob](/docs/developer/templates/tutorials/03-changing-glob) - Glob patterns tutorial
- [Pass Images and Binaries](/docs/developer/templates/how-to/pass-images-binaries) - Handling binary files
- [Conditional Files](/docs/developer/templates/how-to/conditional-files) - Conditional file inclusion
