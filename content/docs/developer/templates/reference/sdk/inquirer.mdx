...
<Callout type="info">
Always namespace your keys to prevent collisions in composed templates. See [How to Use Keys](/docs/developer/templates/how-to/use-keys).
</Callout>

## Related

- [How to Use Keys](/docs/developer/templates/how-to/use-keys) - Keys and namespacing
- [Validate Input](/docs/developer/templates/how-to/validate-input) - Validation patterns
