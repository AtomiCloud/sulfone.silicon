...
<Callout type="warn">
Using `GlobType.Template` on binary files (images, PDFs) will corrupt them. See [Tutorial 3](/developer/templates/tutorials/03-changing-glob) for handling mixed file types.
</Callout>
...
| `var__author__` | Nested variable access |
