...
- [Full installation guide](/docs/user/how-to/install) (pinning versions, more options)
- [Create more projects](/docs/user/how-to/create-project)
- [Browse templates](/docs/user/how-to/browse-templates)
